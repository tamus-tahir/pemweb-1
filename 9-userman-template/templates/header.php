...
<head>
    ...
    <title>USERMAN || <?= strtoupper($uri_segment[2] ? $uri_segment[2] : 'BERANDA'); ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    ...
                    <a class="nav-link <?= $uri_segment[2] == 'halaman' ? 'active' : ''; ?>" href="<?= $base_url . 'halaman'; ?>">HALAMAN</a>

                    <!-- cek jika user telah berhasil login -->
                    <?php if (isset($_SESSION['id_user'])) : ?>
                        <a class="nav-link " href="<?= $base_url . 'admin/dashboard/index'; ?>">DASHBOARD</a>
                    <?php endif ?>
                    <!-- end cek jika user telah berhasil login -->
                </div>
            </div>
        </div>
    </nav>

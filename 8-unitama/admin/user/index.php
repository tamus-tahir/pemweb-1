...
<div class="container card my-5 p-4 shadow">
    ...
    <h1 class="font-title text-primary mb-5">User</h1>
                ...
                <?php foreach ($user as $row) : ?>
                    <tr>
                        ...
                        <td class="text-nowrap">
                            ...
                            <button type="button" class="btn btn-danger" id="btn-modal-delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-url="<?= $base_url . 'admin/user/hapus?id=' . $row['id_user']; ?>">
                                Hapus
                            </button>
                        </td>
                    </tr>

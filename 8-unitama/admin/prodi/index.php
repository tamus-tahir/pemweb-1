...
<div class="container card my-5 p-4 shadow">
    ...
    <h1 class="font-title text-primary mb-5">Prodi</h1>
            ...
            <tbody>
                ...
                <?php foreach ($prodi as $row) : ?>
                    <tr>
                        <th><?= $i++; ?></th>
                        <td><?= $row['prodi']; ?></td>
                        <td class="text-nowrap"><?= $row['akreditasi']; ?></td>
                        <td><?= $row['keterangan']; ?></td>
                        <td class="text-nowrap">
                            <a class="btn btn-warning" href="<?= $base_url . 'admin/prodi/ubah?id=' . $row['id_prodi']; ?>" role="button">Ubah</a>
                            <button type="button" class="btn btn-danger" id="btn-modal-delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-url="<?= $base_url . 'admin/prodi/hapus?id=' . $row['id_prodi']; ?>">
                                Hapus
                            </button>
                        </td>
                    </tr>
